            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200">
                            ...
                            <div class="swiper-container">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    <div class="swiper-slide">
                                        <img src="{{ $product->imageFirst->filename ?? '' }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ $product->imageScound->filename ?? '' }}" alt="">
                                    </div>
                                    <div class="swiper-slide">
                                        <img src="{{ $product->imageThird->filename ?? '' }}" alt="">
                                    </div>
                                </div>
                    ...
                    <div class="border-t border-gray-400 my-8">
                        <div class="mb-4 text-center">販売ショップ</div>
                        <div class="mb-4 text-center">{{ $product->shop->name }}</div>
                        <div class="mb-4 text-center"><img class="mx-auto w-40 h-40 object-cover rounded-full" src="{{ $product->imageFirst->filename ?? '' }}" alt=""></div>
